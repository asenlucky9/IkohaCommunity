...
-- SQL SERVER VERSION (Not PostgreSQL)
-- =====================================================
-- 
-- Instructions:
-- 1. Make sure you're connected to SQL Server (not PostgreSQL)
-- 2. Select the database: USE [Ikoha Community Development];
...
-- =====================================================
-- CREATE ENUM-LIKE TABLES (SQL Server doesn't have ENUMs)
-- =====================================================

-- Note: SQL Server doesn't have ENUM types like PostgreSQL
-- We'll use CHECK constraints instead for data validation
...
CREATE TABLE [dbo].[mineral_resources] (
    ...
    [images] NVARCHAR(MAX) NULL, -- JSON stored as string
...
-- Function to update updated_at timestamp (SQL Server uses triggers differently)
